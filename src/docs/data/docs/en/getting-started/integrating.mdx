...
description: Learn how to integrate Lumenize with an existing template by Cosmic Themes
sidebar:
  order: 3
...
5. Add the docs pages to your site. 
    ...
    From the Lumenize theme copy the whole `src/pages/docs` folder into your site's `src/pages/docs` folder.
