...
2. **[Define your schemas](/docs/guides/schemas)** using our intuitive interface
3. **[Deploy instantly](/docs/getting-started/deployment)** to Cloudflare's global network
4. **[Connect your app](/docs/hosted/signup)** with our client libraries
...
- [Define your schemas](/docs/guides/schemas)
- [Explore pricing plans](/docs/hosted/pricing)
- [View live examples](/docs/examples)
- [Get help on Discord](https://discord.gg/lumenize)