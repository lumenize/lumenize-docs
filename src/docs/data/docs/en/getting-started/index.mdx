...
Lumenize is a modern, fast, and feature-rich documentation template built with Astro v5 and Tailwind CSS v4. It's designed to help you create beautiful and functional documentation websites with minimal setup.
...
Check out the [Theme Integration Guide](/docs/getting-started/integrating) guide to begin using Lumenize Theme with another template by Cosmic Themes.